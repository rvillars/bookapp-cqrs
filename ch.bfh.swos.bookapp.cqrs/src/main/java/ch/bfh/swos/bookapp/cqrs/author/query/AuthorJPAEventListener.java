 ...
 */
@Component
public class AuthorJPAEventListener {
    ...
    public void on(AuthorAddedEvent event) {
        System.out.println("JPA listener reveived author added event for: " + event.getFirstname() + " " + event.getLastname() + " (" + event.getAuthorId() + ")");
        Author author = new Author();
        author.setAuthorId(event.getAuthorId());
        author.setFirstname(event.getFirstname());
        author.setLastname(event.getLastname());
        authorRepository.create(author);
        System.out.println("Author entity persisted");
    }

    @EventHandler
    public void on(AuthorRemovedEvent event) {
        System.out.println("JPA listener reveived author removed event for: " + " (" + event.getAuthorId() + ")");
